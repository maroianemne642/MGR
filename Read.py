...
# carte détectée (pour boucler tant que la carte n'a pas t retiree
Card_Insert = 0
    ...
    while True:
        ...
        if bOK == MIFAREReader.MI_OK:
            ...
            if(bOK == MIFAREReader.MI_OK):
                            ...
                            if bOK == True:
                                ...
                                try:
                                    ...
                                    for c in s:
                                    	if (len(data) < 16):
                                    		data.append(c)
                                    bOK,StatusString=MIFAREReader.MFRC522_Write(B3S12,data)
                ...
                time.sleep(1)
                # -- MIFAREReader.MFRC522_StopCrypto1()
        # si une carte a été inserée, boucler jusqu'a ce que la carte soit retiree
        if Card_Insert==1:
            Card_Insert = 0 # pour ne pas recommencer  la prochaine boucle sans carte
            ...
            while boucle_attente:
                ...
                time.sleep(0.5)
            i = 0
        # Attendre une demie seconde avant de recommencer la boucle princibale
        time.sleep(0.5)
